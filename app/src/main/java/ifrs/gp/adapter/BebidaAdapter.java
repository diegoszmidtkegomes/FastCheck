...
public class BebidaAdapter extends RecyclerView.Adapter<BebidaAdapter.ViewHolder> {
     ...
     */
    public BebidaAdapter(List<Item> avaliacoes) {
     ...
     */
    @Override
    public BebidaAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.list_bebida, parent, false);
     ...
     */
    @Override
    public void onBindViewHolder(BebidaAdapter.ViewHolder holder, int position) {

        Item aval = _avaliacoes.get(position);

        String _titulo = aval.getNome();
        holder.tvProduto.setText(_titulo);
        holder.tvQuant.setText(String.valueOf(aval.getQuantidade()));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            tvProduto = (TextView) v.findViewById(R.id.produto_beb);
            tvQuant = (TextView) v.findViewById(R.id.quantidade_beb);
        }
    }
}
